...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { career: @university.career, name: @university.name, people_id: @university.people_id }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { career: @university.career, name: @university.name, people_id: @university.people_id }
    assert_redirected_to university_path(assigns(:university))
  end
